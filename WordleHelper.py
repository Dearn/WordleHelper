...
with open('slownik5', 'r', encoding='utf-8') as dictionaryFile:
...
layout = [[sg.Push(), sg.Text(label), sg.Input(default, do_not_clear=False, key=key)]
          for label, key in labels_and_keys.items()] + [[sg.Push(), sg.Button('Send')]] + [
...
while True:
    ...
    #sg.Print(MozliweSlowa, len(MozliweSlowa), "\n")
    print(MozliweSlowa, len(MozliweSlowa), "\n")
